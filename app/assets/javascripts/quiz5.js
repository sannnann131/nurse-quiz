...

{
  ...
  const quizSet = [
    ...
    e: '急性心筋梗塞は一般的に激しい胸の痛みを訴える。（背部など広い範囲の痛みを訴えることもある）腎結石は背部、髄膜炎は頭痛と首の痛みを訴える。メニエール病は頭痛やめまいを引き起こす。'},
    {q: '抑うつ状態でみられるのはどれ？', c: ['無気力', 'せん妄', '徘徊','幻覚'],
    e: '抑うつ状態はうつ病ではないものの、気分が落ち込んでいる状態を指す。ちなみにせん妄は高齢者の入院や手術後に多く見られ、注意力の低下や、今いる場所がわからなくなるなどの症状を指す。'},
    {q: '貧血とは、抹消血液中の何が不足することを言う？', c: ['ヘモグロビン濃度', 'アルブミン濃度', '血小板数','血漿量'],
    e: 'ヘモグロビンは血液の中で酸素を運ぶ機能をもつため、貧血となると体内が酸欠状態になり、疲れやめまい、動悸や息切れを起こす。アルブミン濃度は栄養状態を、血小板数は血の固まるスピードを表す。'},
    {q: '鮮紅色(鮮やかな赤色)の下血が見られた時の出血部位で正しいのは？', c: ['直腸', '胃', '十二指腸','食道'],
    e: '直腸は肛門と近いため、血の色がそのままでる。他の3つは肛門と遠いため、その間に酸素と結びつくことで暗い赤色となる。'},
