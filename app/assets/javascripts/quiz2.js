...

{
  ...
  const quizSet = [
    ...
    e: '関節とは骨と骨が連結する部分に当たる。上腕の骨と、肩甲骨はそれぞれ半球のように窪んでいるため、広く動かすことが出来る。腕を回すことができるのも肩関節が球関節であるおかげである。膝関節や肘関節は蝶番関節といわれ、曲げ伸ばしが主な機能になる。下橈尺関節は手の関節を内側に向けたり、外側に向けることができる車軸関節といわれる。'},
  ];
  let currentNum = 0;
  let isAnswered;
  let score = 0;
