...

{
  ...
  const quizSet = [
    ...
    e: '体重70kgの場合42リットルの水分が体内にある。新生児だと80%が水分を占める一方、高齢者になると50%となり脱水になりやすいとされる。'},
    {q: '体温調節中枢はどれ？', c: ['視床下部', '延髄', '小脳','橋'],
    e: '皮膚などの温度受容器で感じた温度を、視床下部で設定された温度と比較し発汗したり、体を震えさせて設定された温度に合わせる。小脳は体のバランスを調整する。延髄は呼吸や循環など生命維持に必須の神経が存在する。'},
    ...
    e: '人間の体のpH7.4であるのに対し、胃液は強い酸性である。この酸性によって食物を殺菌、消化する。なお胃自体が胃液で溶けないのは、胃の内側が粘液が覆っているから。'},
    {q: '脂質1gが体内で代謝されたときに生じるエネルギー量は？', c: ['9kcal', '4kcal', '19kcal','14kcal'],
    e: '炭水化物、タンパク質は1g代謝されると4kcalとなる。'},
  ];
  let currentNum = 0;
  let isAnswered;
  let score = 0;
